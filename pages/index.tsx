...
const Home: NextPage = (props) => {
	...
	return (
		<div className='relatvie h-screen bg-gradient-to-b from-[#333] to=[#141414]'>
			...
			<main>
				<Image src={`https://image.tmdb.org/t/p/original/${props.top[0].backdrop_path}`} alt='image' width={300} height={200} />
			</main>
		</div>
	);
};
...
export const getServerSideProps = async () => {
	...
	return {
		props: { top: top.results, sf: sf.results, drama: drama.results, fantasy: fantasy.results, comedy: comedy.results, action: action.results },
	};
};
